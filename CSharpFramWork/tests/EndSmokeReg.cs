...
using CSharpFramWork.PageObjects;
using CSharpFramWork.Utilities;
...
namespace CSharpFramWork
{
    ...
    public class EndSmokeReg : Base
    {
        ...
        //dotnet test CSharpFramWork.csproj --filter TestCategory=Regression --% -- TestRunParameters.Parameter(name=\"browserName\", value=\"FireFox\")
        //
        //

        // [Parallelizable(ParallelScope.All)]

        public void Fuctions(String username, String password, String[] expectedproducts)
        {
